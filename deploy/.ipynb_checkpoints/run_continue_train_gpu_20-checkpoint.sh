...
exec 1>$PYTHONPATH/info/composition_continue_20.out
exec 2>$PYTHONPATH/info/composition_continue_20.error 
...
--model_save="$PYTHONPATH/ckpts/composition_continue/20" \
--model_load="$PYTHONPATH/ckpts/composition_open/2021_11_03_16_05_epoch20.pkl" \
