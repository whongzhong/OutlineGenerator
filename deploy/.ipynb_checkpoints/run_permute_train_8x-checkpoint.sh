...
exec 1>$PYTHONPATH/info/permute8x.out
exec 2>$PYTHONPATH/info/permute8x.error 
...
--valid_path="$PYTHONPATH/data/datasets/LOTdatasets/permute_data/8x/val.jsonl" \
--tokenizer_path="$TOKENIZER" \
--pretrain_path="$PRETRAIN" \
--model_save="$PYTHONPATH/ckpts/permute_data/8x" \
