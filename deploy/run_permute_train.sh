...
exec 1>$PYTHONPATH/info/permute6x.out
exec 2>$PYTHONPATH/info/permute6x.error 
...
--valid_path="$PYTHONPATH/data/datasets/LOTdatasets/permute_data/6x/val.jsonl" \
--tokenizer_path="$TOKENIZER" \
--pretrain_path="$PRETRAIN" \
--model_save="$PYTHONPATH/ckpts/permute_data/6x" \
