...
exec 1>$PYTHONPATH/info/permute10x.out
exec 2>$PYTHONPATH/info/permute10x.error 
...
TRAIN_PATH="$PYTHONPATH/data/datasets/LOTdatasets/permute_data/8x/train.jsonl"
...
--valid_path="$PYTHONPATH/data/datasets/LOTdatasets/permute_data/10x/val.jsonl" \
--tokenizer_path="$TOKENIZER" \
--pretrain_path="$PRETRAIN" \
--model_save="$PYTHONPATH/ckpts/permute_data/10x" \
