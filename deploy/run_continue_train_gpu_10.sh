...
exec 1>$PYTHONPATH/info/composition_continue_10.out
exec 2>$PYTHONPATH/info/composition_continue_10.error 
...
--model_save="$PYTHONPATH/ckpts/composition_continue/10" \
--model_load="$PYTHONPATH/ckpts/composition_open/2021_11_03_16_05_epoch10.pkl" \
