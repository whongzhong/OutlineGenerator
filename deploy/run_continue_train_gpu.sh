...
exec 1>$PYTHONPATH/info/composition_continue.out
exec 2>$PYTHONPATH/info/composition_continue.error 

# TOKENIZER="fnlp/cpt-large"
# TOKENIZER="$HOME/model/bart_zyfeng/bart-zyfeng"
# TOKENIZER="hfl/chinese-roberta-swwm-ext"
export TOKENIZER="$PYTHONPATH/data/models/CBART"
export PRETRAIN="$PYTHONPATH/data/models/CBART"
...
--model_save="$PYTHONPATH/ckpts/composition_continue" \
--model_load="$PYTHONPATH/ckpts/composition_open/2021_11_03_16_05_epoch15.pkl" \
