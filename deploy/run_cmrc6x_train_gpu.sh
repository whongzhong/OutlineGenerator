...
exec 1>$PYTHONPATH/info/cmrc6x_test.out
exec 2>$PYTHONPATH/info/cmrc6x_test.error 
...
TRAIN_PATH="$PYTHONPATH/data/datasets/LOTdatasets/cmrc_6x/train_6x_cmrc_6x.jsonl"
...
--model_save="$PYTHONPATH/ckpts/cmrc/6x" \
